...
def main(x):
    ...
    x.exec('104-netem-cmd koppa control:part change:add device:left command:"delay 10ms"')
    x.exec('104-netem-cmd koppa control:part change:add device:right command:"delay 10ms"')
    ...
    x.exec('104-netem-cmd koppa control:part change:del device:left command:"delay 10ms"')
    x.exec('104-netem-cmd koppa control:part change:del device:right command:"delay 10ms"')
